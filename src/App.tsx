...
// Lazy load all pages for better code splitting - only Home loads initially
          ...
          <BrowserRouter>
            ...
            <Routes>
              ...
              <Route element={<Layout />}>
                ...
                <Route path="/newsupdates" element={<Suspense fallback={<PageLoader />}><Blog /></Suspense>} />
                <Route path="/newsupdates/:slug" element={<Suspense fallback={<PageLoader />}><BlogDetail /></Suspense>} />
                ...
                <Route path="/case-studies" element={<Suspense fallback={<PageLoader />}><Projects /></Suspense>} />
                <Route path="/case-studies/:slug" element={<Suspense fallback={<PageLoader />}><ProjectDetail /></Suspense>} />
                <Route path="/contact" element={<Suspense fallback={<PageLoader />}><Contact /></Suspense>} />
                <Route path="/faq" element={<Suspense fallback={<PageLoader />}><FAQ /></Suspense>} />
                <Route path="/privacy" element={<Suspense fallback={<PageLoader />}><Privacy /></Suspense>} />
                <Route path="/sitemap.xml" element={<Suspense fallback={<PageLoader />}><Sitemap /></Suspense>} />

      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <Button 
              asChild
              className="bg-primary hover:bg-primary-800 text-white font-telegraf font-semibold px-6 py-2 rounded-lg transition-all duration-200 hover:shadow-lg"
            >
        ...
        {isMenuOpen && (
          <div className="md:hidden py-4 border-t border-gray-100">
            <nav className="flex flex-col space-y-4">
              ...
              <Button 
                asChild
                className="bg-primary hover:bg-primary-800 text-white font-telegraf font-semibold mx-4 mt-2"
              >
                <a href="https://calendly.com/stratumpr" target="_blank" rel="noopener noreferrer">
                  Schedule Consultation
                </a>
